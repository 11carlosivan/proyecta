...
<body class="flex min-h-screen bg-background-light dark:bg-background-dark font-display">
    <div class="flex-1 flex items-center justify-center p-4">
        <div class="w-full max-w-[480px]">
            ...
            <!-- Card de Registro -->
            <div
                class="bg-white dark:bg-[#1c2127] rounded-xl border border-[#e5e7eb] dark:border-[#283039] shadow-lg p-6">
                ...
                <form method="POST" action="" class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-[#111418] dark:text-white mb-2">Nombre
                            Completo</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-[#111418] dark:text-white mb-2">Correo
                            electrónico</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-[#111418] dark:text-white mb-2">Confirmar
                            Contraseña</label>
